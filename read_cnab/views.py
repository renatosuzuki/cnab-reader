...
def upload_file(request):
    if request.method == "POST":
        ...
        for list_line in file_list:
            ...
            reader = CnabReader.objects.create(tipo=tipo, data=data, valor=valor, cpf=cpf, cartao=cartao, 
            hora=horario, dono=dono, loja=loja)

            reader.save()

        operacoes = CnabReader.objects.values("tipo", "valor", "data", "cpf", "hora", "dono", "loja")
